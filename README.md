...
- 🔹 **[DevOps Home Lab](https://github.com/mohammadrezachegini/home-lab)** - Comprehensive hands-on DevOps projects
  - Kubernetes Fundamentals (Pods, ReplicaSets, Deployments, Services)
  - GitHub Actions (20+ workflows + custom actions)
  - Terraform (AWS, GCP, Kubernetes)
  - Monitoring Stack (Prometheus, Grafana, Alertmanager)
  - CI/CD Pipelines (Jenkins, GitLab, GitHub Actions)
  - Cloud Infrastructure (AWS EKS, Auto Scaling, Load Balancers)
  - Configuration Management (Ansible)
  - Application Development (Django, Node.js, Java)
...
<p align="left">
  ...
  <!-- Terraform Associate (Credly) -->
   <a href="https://www.credly.com/badges/4109912f-0d2c-49f2-ac88-bef982058792">
    <img src="https://images.credly.com/images/cd038261-9d1c-4792-bc62-3a3b5bda175c/blob" alt="HashiCorp Certified: Terraform Associate" width="110" />
  </a>
